...
var _display_clips = __webpack_require__(27);

var _display_clips2 = _interopRequireDefault(_display_clips);

var _VideoIndex = __webpack_require__(28);
...
var Root = function (_React$Component) {
	...
	_createClass(Root, [{
		...
		value: function renderContent() {
			...
			if (data) {
				return _react2.default.createElement(_display_clips2.default, { data: data });
			} else {
				return _react2.default.createElement(_VideoIndex2.default, { makeCall: this.makeCall });
			}
		}
	}, {
		key: 'render',
...
var DisplayClips = function (_React$Component) {
	_inherits(DisplayClips, _React$Component);

	function DisplayClips(props) {
		_classCallCheck(this, DisplayClips);

		return _possibleConstructorReturn(this, (DisplayClips.__proto__ || Object.getPrototypeOf(DisplayClips)).call(this, props));
	}

	_createClass(DisplayClips, [{
		key: 'render',
		value: function render() {
			var data = this.props.data;


			var results = data.map(function (clips) {
				return _react2.default.createElement('iframe', { src: clips.embed_url, width: '576', height: '324', frameborder: '0', scrolling: 'no', allowfullscreen: 'true' });
			});
...
var _thumbnail = __webpack_require__(29);

var _thumbnail2 = _interopRequireDefault(_thumbnail);

var _gamesList = __webpack_require__(30);
	...
	_createClass(VideoIndex, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_gamesList2.default.map(function (game) {
					return _react2.default.createElement(_thumbnail2.default, { image: game.clip_url, name: game.display, makeCall: _this2.makeCall, key: game });
				})
			);
		}
	}]);
...
var Thumbnail = function (_React$Component) {
	...
	_createClass(Thumbnail, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				"div",
				{ onClick: this.clickHandler, className: "thumbnail" },
...
var GameList = [{
	query_name: "Overwatch",
	display: "Overwatch",
	clip_url: "https://static-cdn.jtvnw.net/ttv-boxart/Overwatch-285x380.jpg"
}, {
	query_name: "Fortnite",
	display: "Fornite",
	clip_url: "https://static-cdn.jtvnw.net/ttv-boxart/Fortnite-285x380.jpg"
}, {
	query_name: "Street%20Fighter%20V",
	display: "Street Fighter V",
	clip_url: "https://static-cdn.jtvnw.net/ttv-boxart/Street%20Fighter%20V-285x380.jpg"
}, {
	query_name: "Super%20Smash%20Bros.%20Melee",
	display: "Super Smash Bros Melee",
	clip_url: "https://static-cdn.jtvnw.net/ttv-boxart/Super%20Smash%20Bros.%20Melee-285x380.jpg"
}, {
	query_name: "Dragon%20Ball%20FighterZ",
	display: "DragonBall Fighter Z",
	clip_url: "https://static-cdn.jtvnw.net/ttv-boxart/Dragon%20Ball%20FighterZ-285x380.jpg"
}];
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement("i", { id: "search-icon", "class": "fas fa-search" }),
					_react2.default.createElement("input", { className: "search-bar", type: "search" })
				),
