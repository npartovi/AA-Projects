  ...
  _createClass(TodoList, [{
    ...
    value: function render() {
      ...
      var result = todos.map(function (todo) {
        return _react2.default.createElement(_todo_list_item2.default, { title: todo.title, body: todo.body, key: todo.id });
      });
      return _react2.default.createElement(
        'div',
        null,
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          null,
          "Title",
          _react2.default.createElement("input", { type: "text", onChange: this.handleChange('title'), value: this.state.title })
        ),
        _react2.default.createElement(
          "label",
          null,
          "Body",
          _react2.default.createElement("input", { type: "text", onChange: this.handleChange('body'), value: this.state.body })
        ),
        _react2.default.createElement(
          "button",
          null,
